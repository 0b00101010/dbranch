...
class TestCreateSchema:
    ...
    def test_create_basic(self, integration_config, mysql_cleanup):
    ...
    def test_create_duplicate_raises(self, integration_config, mysql_cleanup):
    ...
    def test_create_writes_env_file(self, integration_config, mysql_cleanup):
        ...
        env_path = Path(result["env_files"][0])
        assert env_path.is_file()
        content = env_path.read_text()
        assert f"DB_NAME={schema}" in content

    def test_create_with_description(self, integration_config, mysql_cleanup):
...
class TestListSchemas:
    ...
    def test_list_after_create(self, integration_config, mysql_cleanup):
    ...
    def test_list_older_than_filters(self, integration_config, mysql_cleanup):
...
class TestCloneSchema:
    ...
    def test_clone_basic(self, integration_config, mysql_cleanup):
    ...
    def test_clone_nonexistent_source_raises(self, integration_config, mysql_cleanup):
    ...
    def test_clone_target_exists_raises(self, integration_config, mysql_cleanup):
...
class TestGetStatus:
    ...
    def test_status_no_env_file(self, integration_config, mysql_cleanup):
        """When no .env.db-schema exists, configured should be False."""
        result = get_status(integration_config)

        assert result["project_name"] == integration_config.project_name
    ...
    def test_status_after_create(self, integration_config, mysql_cleanup):
